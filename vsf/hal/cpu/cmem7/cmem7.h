...
typedef struct {                                    /*!< EFUSE Structure                                                       */
  ...
  union {
    __IO uint32_t  USER_CTRL;                       /*!< user region control                                                   */
  ...
  __IO uint32_t  USER_DATA0;                        /*!< user data [31:0]                                                      */
  __IO uint32_t  USER_DATA1;                        /*!< user data [63:32]                                                     */
  __IO uint32_t  USER_DATA2;                        /*!< user data [95:64]                                                     */
  __IO uint32_t  USER_DATA3;                        /*!< user data [127:96]                                                    */
  
  union {
    __IO uint32_t  USER_DATA4;                      /*!< crc and lock bit                                                      */
    
    struct {
      __IO uint32_t  LOCK       :  1;               /*!< write protection if true                                              */
           uint32_t             : 23;
      __IO uint32_t  CRC        :  8;               /*!< CRC                                                                   */
    } USER_DATA4_b;                                 /*!< BitSize                                                               */
  };
} EFUSE_Type;
...
typedef struct {                                    /*!< USB Structure                                                         */
  ...
  union {
    ...
    struct {
      ...
      __IO uint32_t  CorruptTxPkt:  1;         			/*!< always write 0 to this bit                                                     */
    } GUSBCFG_b;                                    /*!< BitSize                                                               */
  };
