...
// GPIO
#define VSFHAL_GPIO_INPUT					0x00
#define VSFHAL_GPIO_OUTPP					0x02
#define VSFHAL_GPIO_OUTOD					0x06
#define VSFHAL_GPIO_PULLUP					0x18
#define VSFHAL_GPIO_PULLDOWN				0x08
#define VSFHAL_GPIO_ANALOG					0x10
#define VSFHAL_GPIO_ALTERNATE_INPUT			0x00	// VSFHAL_GPIO_ALTERNATE_INPUT or VSFHAL_GPIO_ALTERNATE_INPUT | VSFHAL_GPIO_PULLUP or VSFHAL_GPIO_ALTERNATE_INPUT | VSFHAL_GPIO_PULLDOWN
#define VSFHAL_GPIO_ALTERNATE_OUTPP			0x0A
#define VSFHAL_GPIO_ALTERNATE_OUTOD			0x0E
...
#define VSFHAL_USART_CTS					(0x1ul << 1)
#define VSFHAL_USART_RTS					(0x1ul << 0)
